...
export const projects: Project[] = [
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        heading: "Visuals",
        items: [
          "Add screenshot: service configuration flow (IremboGov institution portal)",
          "Add screenshot: white-label storefront configuration",
          "Add screenshot: IremboAI chatbot design system / Angular demo",
          "Add screenshot: performance monitoring dashboard",
        ],
      },
    ],
    prevHref: "/#work",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        heading: "Visuals",
        items: [
          "Add screenshot: sign-in",
          "Add screenshot: nurse home — shift appointments & lab result inbox",
          "Add screenshot: appointments calendar",
          "Add screenshot: patient history — consultations / calls / lab tests / prescriptions / referrals",
          "Add screenshot: radiology test request — conditional modality fields",
          "Add screenshot: radiology report — findings, impression, recommendation",
        ],
      },
    ],
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        heading: "Visuals",
        items: [
          "Add screenshot: wholesale export marketplace",
          "Add screenshot: crop traceability / origin trail view",
          "Add screenshot: field & crop-growth monitoring dashboard",
          "Add screenshot: buyer order flow",
        ],
      },
    ],
    prevHref: "/work/irembo",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        heading: "Visuals",
        items: [
          "Add screenshot: on-site mobile app",
          "Add screenshot: performance monitoring & analytics portal",
        ],
      },
    ],
    prevHref: "/work/naeb",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        heading: "Visuals",
        items: [
          "Add screenshot: Innovate Rwanda public platform",
          "Add screenshot: ecosystem analytics dashboard",
        ],
      },
    ],
    prevHref: "/work/fixa",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        heading: "Visuals",
        items: [
          "Add screenshot: Experts Directory search/listing",
          "Add screenshot: engagement analytics dashboard",
        ],
      },
    ],
